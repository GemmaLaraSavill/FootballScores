...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        // GLS A11y
        mHolder.date.setContentDescription(context.getString(R.string.a11y_time)+" "+cursor.getString(COL_MATCHTIME));
        mHolder.score.setText(Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        // GLS A11y
        mHolder.score.setContentDescription(context.getString(R.string.a11y_score)+" "+ Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            // GLS A11y
            league.setContentDescription(context.getString(R.string.a11y_league)+" "+ Utilies.getLeague(cursor.getInt(COL_LEAGUE)));
